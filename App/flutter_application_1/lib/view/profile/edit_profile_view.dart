                                  ...
                                  CustomTextFormField(
                                    ...
                                    validatorFn: (value) {
                                      if (value!.isEmpty || value.length < 4)
                                        return 'Por favor escreva um nome válido.';
                                      return null;
                                    },
                                    onSavedFn: (value) {
                                  ...
                                  Column(
                                    children: [
                                      CustomTextFormField(
                                        ...
                                        validatorFn: (value) {
                                          if (value!.isEmpty)
                                            return 'Por favor escreva um Email válido.';
                                          return null;
                                        },
                                        onSavedFn: (value) {
                                      ...
                                      CustomTextFormField(
                                        ...
                                        validatorFn: (value) {
                                          if (value!.isEmpty ||
                                              value.length < 6)
                                            return 'Password deve ter 6 caracteres no minimo.';
                                          return null;
                                        },
                                        onSavedFn: (value) {
                                          Get.find<ProfileViewModel>()
