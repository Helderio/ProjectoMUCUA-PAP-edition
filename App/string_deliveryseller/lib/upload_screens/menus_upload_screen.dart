...
class _MenusUploadScreenState extends State<MenusUploadScreen> {
  ...
  defaultScreen() {
    ...
    Color(0xFF0D47A1), // azul escuro
        ...
        title: Text(
          "Adicionar novo menu".toUpperCase(),
  ...
  validateUploadForm() async {
    if (imageXFile != null) {
        ...
        showDialog(
          ...
          builder: (c) {
            return const ErrorDialog(
              message: "Por favor, escreva o título e as informações para o menu.",
            );
          },
        );
      }
      ...
      showDialog(
        ...
        builder: (c) {
          return const ErrorDialog(
            message: "Por favor, escolha uma imagem para o menu.",
          );
        },
      );
    }
