...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Color(0xFF0D47A1), // azul escuro
        ...
        title: Text(
          "Olá " + sharedPreferences!.getString("name")!.toUpperCase(),
    ...
    Color(0xFF0D47A1), // azul escuro
        ...
        child: GridView.count(
          ...
          children: [
            makeDashboardItem("Novas disponíveis", Icons.assignment, 0),
            makeDashboardItem("Entregas em Progresso", Icons.airport_shuttle, 1),
            makeDashboardItem("Ainda não entregue.", Icons.location_history, 2),
            makeDashboardItem("Histórico", Icons.done_all, 3),
            makeDashboardItem("Total ganho", Icons.monetization_on, 4),
            makeDashboardItem("sair", Icons.logout, 5),
          ],
        ),
      ),
    );
